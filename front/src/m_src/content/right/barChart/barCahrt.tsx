...
const BarChart = (props: any) => {
  ...
  const [dimensions, setDimensions] = useState({ width: window.innerWidth, height: 300 });

  // 화면 크기 변화에 대응하기 위한 hook
  useEffect(() => {
    const handleResize = () => {
  ...
  }, [props.getTodayList, dimensions]); // 화면 크기 변화에 대응하기 위해 'dimensions' 추가
